...
class AppColors {
  ...
  static Color primaryColor = Color(0xFFee7b64);
  //Color(0xff467df1);
  ...
  static const Color onboardingPageColor4 = Color(0xffFDB99B);
  ...
  static const Color textFieldFocusBorderColor = Color.fromRGBO(
      19, 43, 103, 1.0);
